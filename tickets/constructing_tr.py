            ...
            if value_vars.get('type_install_csw'):
                ...
                if sreda == '1':
                    ...
                    if value_vars.get('ppr'):
                        hidden_vars[
                            '- Требуется отключение согласно списку отключений в ППР %№ заявка ППР% согласовать проведение работ.'] = '- Требуется отключение согласно списку отключений в ППР %№ заявка ППР% согласовать проведение работ.'
                        hidden_vars[
                            '- Совместно с ОНИТС СПД убедиться в восстановлении связи согласно списку отключений в ППР %№ заявка ППР%.'] = '- Совместно с ОНИТС СПД убедиться в восстановлении связи согласно списку отключений в ППР %№ заявка ППР%.'
                        hidden_vars[
                            '- После проведения монтажных работ убедиться в восстановлении услуг согласно списку отключений в ППР %№ заявка ППР%.'] = '- После проведения монтажных работ убедиться в восстановлении услуг согласно списку отключений в ППР %№ заявка ППР%.'
...
def exist_enviroment_install_csw(value_vars):
    ...
    stroka = templates.get("Установка клиентского коммутатора.")
    if value_vars.get('ppr'):
        hidden_vars['- Требуется отключение согласно списку отключений в ППР %№ заявка ППР% согласовать проведение работ.'] = '- Требуется отключение согласно списку отключений в ППР %№ заявка ППР% согласовать проведение работ.'
        hidden_vars['- Совместно с ОНИТС СПД убедиться в восстановлении связи согласно списку отключений в ППР %№ заявка ППР%.'] = '- Совместно с ОНИТС СПД убедиться в восстановлении связи согласно списку отключений в ППР %№ заявка ППР%.'
        hidden_vars['- После проведения монтажных работ убедиться в восстановлении услуг согласно списку отключений в ППР %№ заявка ППР%.'] = '- После проведения монтажных работ убедиться в восстановлении услуг согласно списку отключений в ППР %№ заявка ППР%.'
        static_vars['№ заявка ППР'] = value_vars.get('ppr')
...
def get_add_kad(value_vars):
    ...
    if value_vars.get('ppr'):
        hidden_vars[
            '- Требуется отключение согласно списку отключений в ППР %№ заявка ППР% согласовать проведение работ.'
        ] = '- Требуется отключение согласно списку отключений в ППР %№ заявка ППР% согласовать проведение работ.'
        hidden_vars[
            '- Совместно с ОНИТС СПД убедиться в восстановлении связи согласно списку отключений в ППР %№ заявка ППР%.'
        ] = '- Совместно с ОНИТС СПД убедиться в восстановлении связи согласно списку отключений в ППР %№ заявка ППР%.'
        hidden_vars[
            '- После проведения монтажных работ убедиться в восстановлении услуг согласно списку отключений в ППР %№ заявка ППР%.'
        ] = '- После проведения монтажных работ убедиться в восстановлении услуг согласно списку отключений в ППР %№ заявка ППР%.'
        static_vars['№ заявка ППР'] = value_vars.get('ppr')
