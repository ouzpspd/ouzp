...
from oattr.models import HoldPosition, UserHoldPosition, OtpmSpp
...
class ViewsTestCase(TestCase):
    ...
    def test_call_view_create_spp(self):
        dID = '141891'
        response = self.client.get(f'/otpm/create_spp/{dID}/?stage=В работе ОТПМ')
        created_spp = str(OtpmSpp.objects.last())
        self.assertEqual(created_spp, '2022_00876')
        self.assertRedirects(response, reverse('spp_view_oattr', kwargs={'dID': dID}))